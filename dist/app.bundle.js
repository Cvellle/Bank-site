...
"use strict";
eval("\n\n__webpack_require__(/*! ../styles/main.scss */ \"./assets/styles/main.scss\");\n\n__webpack_require__(/*! ../scripts/modules/mobileNavToggle */ \"./assets/scripts/modules/mobileNavToggle.js\");\n\n__webpack_require__(/*! ../scripts/modules/toggleBenefits.js */ \"./assets/scripts/modules/toggleBenefits.js\");\n\n__webpack_require__(/*! ../scripts/modules/eBankingSlider.js */ \"./assets/scripts/modules/eBankingSlider.js\");\n\n__webpack_require__(/*! ../scripts/modules/coverSlider.js */ \"./assets/scripts/modules/coverSlider.js\");\n\n__webpack_require__(/*! ../scripts/modules/toggleTables.js */ \"./assets/scripts/modules/toggleTables.js\");\n\n__webpack_require__(/*! ../scripts/modules/footerGasp.js */ \"./assets/scripts/modules/footerGasp.js\");\n\n__webpack_require__(/*! ../scripts/modules/scrollToTop.js */ \"./assets/scripts/modules/scrollToTop.js\");\n\n__webpack_require__(/*! ../scripts/modules/headerArrowGasp.js */ \"./assets/scripts/modules/headerArrowGasp.js\");\n\n__webpack_require__(/*! ../scripts/modules/magazineHover.js */ \"./assets/scripts/modules/magazineHover.js\");\n\n__webpack_require__(/*! ../scripts/modules/specialScroll.js */ \"./assets/scripts/modules/specialScroll.js\");\n\n//# sourceURL=webpack:///./assets/scripts/index.js?");

/***/ }),

/***/ "./assets/scripts/modules/coverSlider.js":
/*!***********************************************!*\
  !*** ./assets/scripts/modules/coverSlider.js ***!
  \***********************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nfunction _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }\n\nfunction slider() {\n  var sliderImagesRow = document.querySelector(\".eBanking__imagesSlidingRow\");\n  var allSliderImages = document.querySelectorAll(\".eBanking__imagesSlidingRow img\");\n  var sliderCircleButtons = document.querySelectorAll(\".eBanking__sliderBtn\");\n\n  var secondsCount = 0;\n  var positionCount = 1;\n\n  var changePosition = function changePosition(oldCountPar) {\n    sliderImagesRow.classList.replace(\"eBanking__imagesSlidingRow--position\" + oldCountPar, \"eBanking__imagesSlidingRow--position\" + positionCount);\n  };\n\n  var changeActiveButton = function changeActiveButton() {\n    sliderCircleButtons.forEach(function (el, i) {\n      return el.classList.contains(\"eBanking__sliderBtn--activeBtn\") ? el.classList.remove(\"eBanking__sliderBtn--activeBtn\") : null;\n    });\n    sliderCircleButtons[positionCount - 1].classList.add(\"eBanking__sliderBtn--activeBtn\");\n  };\n\n  var changeAriaHidden = function changeAriaHidden(shownPar, hiddenPar) {\n    allSliderImages[shownPar - 1].setAttribute(\"aria-hidden\", \"true\");\n    allSliderImages[hiddenPar - 1].setAttribute(\"aria-hidden\", \"false\");\n  };\n\n  var autoPlaySlider = function autoPlaySlider() {\n    secondsCount += 1;\n    secondsCount == 4 ? scrollSlider(true) : null;\n  };\n\n  var scrollSlider = function scrollSlider(autoPlay) {\n    var moveLeftFunction = function moveLeftFunction(leftToRight) {\n      secondsCount = 0;\n      var oldCount = positionCount;\n      var moveLeftLoop = function moveLeftLoop() {\n        return positionCount == 1 ? positionCount = 4 : positionCount -= 1;\n      };\n      var moveRightLoop = function moveRightLoop() {\n        return positionCount >= 4 ? positionCount = 1 : positionCount += 1;\n      };\n      leftToRight ? moveLeftLoop() : moveRightLoop();\n      changePosition(oldCount);\n      changeActiveButton();\n      changeAriaHidden(oldCount, positionCount);\n    };\n    autoPlay ? moveLeftFunction(false) : null;\n\n    return function (event) {\n      if (event.target.matches(\".eBanking__arrow\")) {\n        event.target.matches(\".eBanking__arrow--left\") ? moveLeftFunction(true) : moveLeftFunction(false);\n        changeActiveButton();\n      }\n      if (event.target.matches(\".eBanking__sliderBtn\")) {\n        secondsCount = 0;\n        var oldCount = positionCount;\n        positionCount = [].concat(_toConsumableArray(sliderCircleButtons)).indexOf(event.target) + 1;\n        changePosition(oldCount);\n        changeActiveButton();\n        changeAriaHidden(oldCount, positionCount);\n      }\n    };\n  };\n\n  setInterval(autoPlaySlider, 1000);\n\n  var debounce = function debounce(callback, wait) {\n    var timeoutId = null;\n    return function () {\n      for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {\n        args[_key] = arguments[_key];\n      }\n\n      window.clearTimeout(timeoutId);\n      timeoutId = window.setTimeout(function () {\n        callback.apply(null, args);\n      }, wait);\n    };\n  };\n\n  window.addEventListener(\"click\", debounce(scrollSlider(), 200));\n}\n\nwindow.addEventListener(\"load\", slider);\n\n//# sourceURL=webpack:///./assets/scripts/modules/eBankingSlider.js?");

/***/ }),

/***/ "./assets/scripts/modules/footerGasp.js":
/*!**********************************************!*\
  !*** ./assets/scripts/modules/footerGasp.js ***!
  \**********************************************/
/*! no static exports found */
...
"use strict";
eval("\n\n$(document).ready(function () {\n  var $box = $(\"#mobileDiv > div\");\n  var a = false;\n  var b = false;\n  var startAt = $(\".footer\").offset().top + $(window).height() / 10;\n\n  $(window).scroll(function () {\n    if ($(window).scrollTop() > startAt) {\n      a = true;\n\n      if (a !== b) {\n        TweenLite.fromTo($box, 1.5, { y: \"+=0\" }, {\n          y: 0,\n          ease: Power4.easeInOut\n        });\n      }\n      b = true;\n    }\n  });\n});\n\n//# sourceURL=webpack:///./assets/scripts/modules/footerGasp.js?");

/***/ }),

/***/ "./assets/scripts/modules/headerArrowGasp.js":
/*!***************************************************!*\
  !*** ./assets/scripts/modules/headerArrowGasp.js ***!
  \***************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\n$(document).ready(function () {\n  var screenWidthLimit = window.matchMedia(\"screen and (min-width: 1025px)\");\n\n  if (screenWidthLimit.matches) {\n    var iconsHoverIn = function iconsHoverIn() {\n      TweenMax.to($(this).find(\".header__mobArrow\"), 0.3, {\n        rotationX: \"-180\"\n      });\n    };\n    var iconsHoverOut = function iconsHoverOut() {\n      TweenMax.to($(this).find(\".header__mobArrow\"), 0.3, {\n        rotationX: 0\n      });\n    };\n    $(\".header__dropDownDiv\").hover(iconsHoverIn, iconsHoverOut);\n  }\n});\n\n//# sourceURL=webpack:///./assets/scripts/modules/headerArrowGasp.js?");

/***/ }),

/***/ "./assets/scripts/modules/magazineHover.js":
/*!*************************************************!*\
  !*** ./assets/scripts/modules/magazineHover.js ***!
  \*************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\n$(document).ready(function () {\n  $(\".footer__returnImage\").on(\"click\", function () {\n    window.scrollTo(0, 0);\n  });\n});\n\n//# sourceURL=webpack:///./assets/scripts/modules/scrollToTop.js?");

/***/ }),

/***/ "./assets/scripts/modules/specialScroll.js":
/*!*************************************************!*\
  !*** ./assets/scripts/modules/specialScroll.js ***!
  \*************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\n$(document).ready(function () {\n  var $box = $(\"#mobileDiv > div\");\n  var a = false;\n  var b = false;\n  var startAt = $(window).height() / 3;\n\n  $(window).scroll(function () {\n    if ($(window).scrollTop() > startAt) {\n      a = true;\n\n      if (a !== b) {\n        $(\".special__article\").addClass(\"special__article--visible\");\n      }\n      b = true;\n    }\n  });\n});\n\n//# sourceURL=webpack:///./assets/scripts/modules/specialScroll.js?");

/***/ }),

/***/ "./assets/scripts/modules/toggleBenefits.js":
/*!**************************************************!*\
  !*** ./assets/scripts/modules/toggleBenefits.js ***!
  \**************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nvar screenWidthLimit = window.matchMedia(\"screen and (min-width: 1025px)\");\n\n$(document).ready(function () {\n  if (!screenWidthLimit.matches) {\n    $(\".benefits__first\").click(function () {\n      $(this).next().slideToggle(\"slow\");\n      $(this).children().last().toggleClass(\"benefits__arrowImg--rotated\");\n    });\n  }\n});\n\n//# sourceURL=webpack:///./assets/scripts/modules/toggleBenefits.js?");

/***/ }),

/***/ "./assets/scripts/modules/toggleTables.js":
/*!************************************************!*\
  !*** ./assets/scripts/modules/toggleTables.js ***!
  \************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\n$(document).ready(function () {\n  $(\".table__button\").click(function () {\n    $(this).next().slideToggle(\"slow\");\n    $(this).children().last().toggleClass(\"table__dropImg--rotated\");\n  });\n\n  $(\".table__closeBtn\").click(function () {\n    $(this).parent().parent().slideToggle(\"slow\");\n    $(this).parent().parent().prev().children().last().toggleClass(\"table__dropImg--rotated\");\n  });\n});\n\n//# sourceURL=webpack:///./assets/scripts/modules/toggleTables.js?");
